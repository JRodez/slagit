...
htmlhelp_basename = 'sharelatexdoc'
...
latex_documents = [
    (master_doc, 'sharelatex.tex', u'sharelatex Documentation',
     u'Matthieu Simonin, Guillermo Andrade', 'manual'),
]
...
man_pages = [
    (master_doc, 'sharelatex', u'sharelatex Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sharelatex', u'sharelatex Documentation',
     author, 'sharelatex', 'One line description of project.',
     'Miscellaneous'),
]
